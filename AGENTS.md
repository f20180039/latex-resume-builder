# Codex Context: LaTeX Resume Template
...
8. **Document new commands**: If adding commands to commands.tex, document them in AGENTS.md
9. **Preserve legacy**: Don't delete `legacy/` files - they provide reference and context
10. **Check README**: User-facing documentation is in README.md - keep it in sync with AGENTS.md
